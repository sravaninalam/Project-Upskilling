...
public class StudentController {
    ...
    public ResponseEntity<List<Student>> getStudents(){
        ...
        students.add(new Student(1, "Ram", "sai"));
        students.add(new Student(2, "maha", "lakshmi"));
        students.add(new Student(3, "Rekha", "chandana"));
        students.add(new Student(4, "Sara", "nalam"));
